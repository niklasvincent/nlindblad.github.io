...
As my career has progressed, I decided to make a [visual timeline](http://127.0.0.1:4000/about.html#timeline) (based on [this example](http://codepen.io/P233/pen/lGewF)) instead of writing everything out in paragraphs.
